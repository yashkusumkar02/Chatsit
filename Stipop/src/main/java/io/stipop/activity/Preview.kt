@file:Suppress("ControlFlowWithEmptyBody", "ControlFlowWithEmptyBody", "LiftReturnOrAssignment", "unused", "unused")
...
class Preview(val activity: Activity, private val keyboard: Keyboard) : PopupWindow() {
