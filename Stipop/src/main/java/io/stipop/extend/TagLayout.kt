@file:Suppress("PropertyName", "PropertyName", "ReplaceJavaStaticMethodWithKotlinAnalog", "PrivatePropertyName", "PrivatePropertyName", "PrivatePropertyName", "PrivatePropertyName", "PrivatePropertyName", "PrivatePropertyName", "PrivatePropertyName")
...
class TagLayout: ViewGroup {
    ...
    private var vertical_spacing = 10
    private var line_height = 0


    private val itemPadding = 5
    private var rowPaddingTmp = ArrayList<Int>()
